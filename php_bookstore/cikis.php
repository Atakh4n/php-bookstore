...
<head>
    ...
    <link href="./bootstrap/css/giris.css" rel="stylesheet">
...
<div class="animation01">
    ...
    <div class="animation04">
        ...
        <div class="name"> <h4 style="font-family: 'Oldenburg', cursive;font-size: 100px;color: black; text-align:center; ">ÇIKIŞ YAPILDI</h4></div>
    </div>
</body>
</html>